 ...
 * Owner: WS-F.
 */
export type CollectionListSettings = Extract<Section, { type: 'collection-list' }>['settings'];

export function CollectionList({ settings }: { settings: CollectionListSettings }) {
  // TODO(WS-F): implement. Keep it pure — no data fetching inside a section.
  return (
    <section data-section="collection-list" className="w-full">
